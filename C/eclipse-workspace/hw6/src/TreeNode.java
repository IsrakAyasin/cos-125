public class TreeNode<T> {
	...
	public String preorder() {
	    if (isLeaf()) {
	        ...
	        return (element != null ? element.toString() + " " : "") + left.preorder();
	    } else if (left == null && right != null) {
	        return (element != null ? element.toString() + " " : "") + right.preorder();
	    } else {
	        return (element != null ? element.toString() + " " : "") + left.preorder() + " " + right.preorder();
	    }
	}
	...
	public String postorder() {
	    if (isLeaf()) {
	        ...
	        return left.postorder() + " " + (element != null ? element.toString() : "");
	    } else if (left == null && right != null) {
	        return right.postorder() + " " + (element != null ? element.toString() : "");
	    } else {
	        return left.postorder() + " " + right.postorder() + " " + (element != null ? element.toString() : "");
	    }
	}
